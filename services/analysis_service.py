...
class AnalysisService:
    ...
    def analyze_repository_full(
        ...
        try:
            ...
            logger.info(f"Analysis completed: {analysis_result.summary['total_functions']} functions found")
    ...
    def analyze_repository_structure_only(
        ...
        try:
            ...
            logger.info(f"Structure analysis completed: {result['file_summary']['total_files']} files found")
            return result
...
def analyze_repository_structure_only(github_url: str, include_patterns=None, exclude_patterns=None) -> tuple[Dict, None]:
    """
    Backward compatibility function.
